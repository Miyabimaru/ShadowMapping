...
{
	glUniform4fv(_shaderProgram->uniform("PointLights[" + std::to_string(Id) + "].Position"), 1, glm::value_ptr(view * Position));
	glUniform3fv(_shaderProgram->uniform("PointLights[" + std::to_string(Id) + "].La"), 1, glm::value_ptr(La));
	glUniform3fv(_shaderProgram->uniform("PointLights[" + std::to_string(Id) + "].Ld"), 1, glm::value_ptr(Ld));
	glUniform3fv(_shaderProgram->uniform("PointLights[" + std::to_string(Id) + "].Ls"), 1, glm::value_ptr(Ls));
}
